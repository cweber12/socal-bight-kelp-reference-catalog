...
report draws no county boundary and never names Santa Barbara County. Two audits of PR #124 shaped
...
source's coverage reaches. The two audits of PR #124 are why each of those sentences is there. Slice
16 then writes its six records under 16e's sentences. Slice 18 closes #18. 18a follows 16e, not
in any order: #105's seam is the tagging sentence 16e replaces, so 18a is re-scoped to the
wider-than-Bight clause of the new sentence and waits on the owner's reading in #105.
