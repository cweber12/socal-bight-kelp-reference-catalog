"""Fetch the Bight '08 Rocky Reefs report into data/raw/sccwrp_b08_rocky_reef/.

Run:  python src/fetch/sccwrp_b08_rocky_reef.py
...
SOURCE_ID = "sccwrp_b08_rocky_reef"
FILES = ("https://ftp.sccwrp.org/pub/download/DOCUMENTS/TechnicalReports/685_B08RockyReef.pdf",)
PDF_MAGIC = b"%PDF-"
