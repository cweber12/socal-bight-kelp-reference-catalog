"""Fetch the SBC LTER kelp removal sessile cover table into data/raw/sbc_lter_kelp_removal_cover/.

Run:  python src/fetch/sbc_lter_kelp_removal_cover.py
...
This is the shape of src/fetch/sbc_lter_kelp_biomass.py. FILES holds PASTA identifiers,
not URLs, each with the SHA-1 and the size DataONE's system metadata stated for it on
2026-09-20; the identifier carries the package revision, 33. EDI's own PASTA service
...
(catalog/sources/sbc_lter_kelp_removal_cover.md, `access`; CONTEXT.md, "Vocabularies",
...
SOURCE_ID = "sbc_lter_kelp_removal_cover"
USER_AGENT = "kelpcatalog/knb-lter-sbc.28"
...
FILES = (
    (
        ...
        "7d274b95564351726ae4707b230e8b46dd1f78cb",
        107784745,
    ),
)
CHUNK = 1 << 20
