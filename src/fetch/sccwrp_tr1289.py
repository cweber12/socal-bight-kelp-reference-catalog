"""Fetch the Bight '18 Benthic Infauna report into data/raw/sccwrp_tr1289/.

Run:  python src/fetch/sccwrp_tr1289.py
...
Same shape as src/fetch/sccwrp_b08_rocky_reef.py, the other SCCWRP report on the same
host: the %PDF- body check, because a truncated or error-bodied 200 would otherwise be
stored, hashed and manifested as a VERIFIED fetch with nothing to reveal it, and the
300-second timeout, for a file of this size.
"""
